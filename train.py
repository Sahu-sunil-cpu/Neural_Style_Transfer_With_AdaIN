...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default='C:/Users/Sunil Sahu/APNA_AIML_PROJECTS/Neural_Style_Transfer_With_adaIN/content_data', help="Location of content dataset")
        
    parser.add_argument('--style_dir', type=str, default='C:/Users/Sunil Sahu/APNA_AIML_PROJECTS/Neural_Style_Transfer_With_adaIN/style_data', help='Location of style dataset')
        
    # parser.add_argument('--content_dir', type=str, default='AdaIn_Dataset/train_2', help="Location of content dataset")
            
    # parser.add_argument('--style_dir', type=str, default='AdaIn_Dataset/test2017', help='Location of style dataset')
             
    parser.add_argument('--vgg', type=str, default='C:/Users/Sunil Sahu/APNA_AIML_PROJECTS/Neural_Style_Transfer_With_adaIN/vgg_normalised.pth', help='Location of pre-trained VGG')
